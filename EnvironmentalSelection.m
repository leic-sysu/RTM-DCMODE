function [Population,z,znad,z_c,znad_c,f_x,cons] = EnvironmentalSelection(Population,W,N,z,znad,z_c,znad_c,objs,cons)
% The environmental selection of DCMODE
...
% This function is written by Fei Ming (email: 20151000334@cug.edu.cn)
    ...
    %% Normalization
    [PopObj,PopCon,z,znad,z_c,znad_c] = Normalization(objs(St,:),cons(St,:),z,znad,z_c,znad_c);
