function [obj] = costFun_SAD(x0,R_rs_true,theta_w,theta_v,a_w,b_w,a0,a1,endmembers,SRF)
% Calculate the SAD objective function
% Input:
...
% Output:
%   obj:        SAD value between the observed spectrum and the simulated spectrum
...
obj = SAM(R_rs_model,R_rs_true); % SAD
end